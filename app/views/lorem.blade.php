...
?>
      ...
      <section id="lorem" class="content-section text-left">
        <div class='download-section'>
          ...
          <div class="container">
            <div class="col-lg-offset-1">
              ...
              {{ Form::label('paragraphs', 'Paragraph amount: ') }}


              {{ Form::text( 'paragraphs', '1', array('id' => 'paragraphs', 'maxlength' => 2)) }} (Default 1 | Maximum: 99)
